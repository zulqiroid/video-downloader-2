...
import com.all.video.downloader.fast.hd.secure.video.downloader.presentation.screens.vault.componants.VaultDeleteConfirmDialog
import com.all.video.downloader.fast.hd.secure.video.downloader.presentation.screens.vault.componants.VaultDeleteSuccessDialog
import com.all.video.downloader.fast.hd.secure.video.downloader.presentation.screens.vault.componants.VaultDeletingFileDialog
import com.all.video.downloader.fast.hd.secure.video.downloader.presentation.screens.vault.componants.VaultFirstTimeDialog
import com.all.video.downloader.fast.hd.secure.video.downloader.presentation.screens.vault.componants.VaultHomeContent
import com.all.video.downloader.fast.hd.secure.video.downloader.presentation.screens.vault.componants.VaultIncorrectPinDialog
import com.all.video.downloader.fast.hd.secure.video.downloader.presentation.screens.vault.componants.VaultOriginalDeleteInfoDialog
import com.all.video.downloader.fast.hd.secure.video.downloader.presentation.screens.vault.componants.VaultPinSetupContent
import com.all.video.downloader.fast.hd.secure.video.downloader.presentation.screens.vault.componants.VaultPreparingPlaybackDialog
import com.all.video.downloader.fast.hd.secure.video.downloader.presentation.screens.vault.componants.VaultRestoreConfirmDialog
import com.all.video.downloader.fast.hd.secure.video.downloader.presentation.screens.vault.componants.VaultRestoreSuccessDialog
import com.all.video.downloader.fast.hd.secure.video.downloader.presentation.screens.vault.componants.VaultRestoringFileDialog
import com.all.video.downloader.fast.hd.secure.video.downloader.presentation.screens.vault.componants.VaultSecuringFileDialog
 import com.all.video.downloader.fast.hd.secure.video.downloader.presentation.screens.vault.componants.VaultUnlockContent
    ...
    Scaffold(
        ...
        topBar = {
            Column(
                ...
                ScreenNativeAd(
                    screenKey = VideoDownloaderAdScreenKeys.VAULT,
                    position = AdSlotPosition.TOP,
                    modifier = Modifier.fillMaxWidth(),
                    spacingBefore = 0.dp
                )
        ...
        Box(
            ...
            state.errorMessage?.let { message ->
                androidx.compose.material3.Text(
                    ...
                    style = com.all.video.downloader.fast.hd.secure.video.downloader.presentation.theme.AppTextStyles.bodySmall,
                    modifier = Modifier
